...
function storageify(Component, options) {
    ...
    return function (sources) {
        ...
        var state$ = sources.state.stream.compose(_options.debounce ? debounce_1.default(_options.debounce) : function (x) { return x; });
        ...
        var sinks = __assign(__assign({}, componentSinks), { state: parentReducer$, storage: xstream_1.default.merge(storage$, componentSinks.storage || xstream_1.default.never()) });
        return sinks;
    };
}
